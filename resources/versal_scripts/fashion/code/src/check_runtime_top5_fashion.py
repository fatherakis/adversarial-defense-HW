...
ap.add_argument("-n", "--numel", default="10000", help="number of test images")
...
labelNames = { 'T-shirt' : 0, 'Trouser' : 1, 'Pullover' : 2, 'Dress' : 3, 'Coat' : 4,
...
print("top1 accuracy = %.5f" % top1_accuracy)
print("top5 accuracy = %.5f" % top5_accuracy)
